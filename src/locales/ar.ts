...
export default {
  ...
  inv_reason_correction: "تصحيح المخزون",
  inv_reason_found: "وجدت كمية إضافية",
  inv_reason_damaged: "بضاعة تالفة",
  inv_reason_expired: "منتهية الصلاحية",
  ...
  refund_count: "عدد الاستردادات",
  refund_subtotal: "المبلغ الفرعي للاسترداد",
  refund_tax: "ضريبة الاسترداد",
  refund_service_charge: "رسوم خدمة الاسترداد",
  total_refunded: "إجمالي المسترد",
  cash_refunds: "استرداد نقدي",
  card_refunds: "استرداد بطاقة",
  mobile_refunds: "استرداد موبايل",
  adjusted_totals: "المجاميع المعدلة",
  after_refunds: "بعد الاستردادات",

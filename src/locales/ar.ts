...
export default {
  ...
  inv_item_deleted: "تم حذف الصنف بنجاح",
  inv_delete_item_title: "حذف صنف المخزون",
  inv_delete_item_desc: "هل أنت متأكد من حذف هذا الصنف؟ لا يمكن التراجع عن هذا الإجراء:",
  ...
  inv_missing_unit: "اسم الوحدة مفقود",
  inv_unit_create_failed: "فشل إنشاء الوحدة",
  inv_units_created: "وحدات جديدة مُضافة",
  ...
  recipes_failed: "الوصفات الفاشلة",
  recipes_created_successfully: "تم إنشاء الوصفات بنجاح!",
  import_errors: "أخطاء الاستيراد",
  csv_invalid_rows_warning: "الصفوف التي تحتوي على أخطاء سيتم تخطيها. الصفوف الصحيحة سيتم استيرادها.",
  csv_error_menu_item_not_found: "صنف القائمة غير موجود",
  csv_error_menu_item_not_unique: "يوجد أكثر من صنف قائمة بهذا الاسم",
  csv_error_inventory_item_not_found: "صنف المخزون غير موجود",
  csv_error_inventory_item_not_unique: "يوجد أكثر من صنف مخزون بهذا الاسم",
  csv_error_unit_not_found: "الوحدة غير موجودة",
  csv_error_invalid_quantity: "الكمية يجب أن تكون رقماً موجباً",
  csv_error_database_error: "فشل حفظ الوصفة في قاعدة البيانات",
  ...
  sub_renew_preview: "معاينة الفترة الجديدة",
  sub_renew_new_start: "تاريخ البدء الجديد",
  sub_renew_new_end: "تاريخ الانتهاء الجديد",
  sub_renew_expired_note: "سيبدأ الاشتراك من اليوم لأن الاشتراك السابق منتهي",
  sub_renew_active_note: "سيبدأ الاشتراك من اليوم التالي لانتهاء الاشتراك الحالي",
  sub_renew_success_title: "تم التجديد بنجاح",
  sub_renew_success_desc: "تم تجديد الاشتراك بنجاح",
  sub_current_status: "الحالة الحالية",
  sub_current_end: "تاريخ الانتهاء الحالي",
  sub_active: "نشط",
  ...
  sub_start_date_helper: "اختر تاريخ بدء الاشتراك. يمكنك تعديله في أي وقت.",
  sub_end_date: "تاريخ الانتهاء (محسوب)",
  sub_end_date_helper: "يُحسب تلقائياً بناءً على تاريخ البدء والمدة والأشهر المجانية.",
  sub_pick_date: "اختر تاريخ",
  ...
  days_remaining_tooltip: "عدد الأيام المتبقية على انتهاء الاشتراك",
  inv_enabled_tooltip: "إدارة المخزون مفعّلة",
  inv_disabled_tooltip: "إدارة المخزون غير مفعّلة",
  kds_enabled_tooltip: "شاشة المطبخ مفعّلة",
  kds_disabled_tooltip: "شاشة المطبخ غير مفعّلة",
  qr_enabled_tooltip: "الطلب عبر QR مفعّل",
  qr_disabled_tooltip: "الطلب عبر QR غير مفعّل",
  // Module toggle toast messages
  toast_inv_enabled_title: "تم تفعيل إدارة المخزون",
  toast_inv_enabled_desc: "تم تفعيل إدارة المخزون بنجاح",
  toast_inv_disabled_title: "تم تعطيل إدارة المخزون",
  toast_inv_disabled_desc: "تم تعطيل إدارة المخزون",
  toast_kds_enabled_title: "تم تفعيل شاشة المطبخ",
  toast_kds_enabled_desc: "تم تفعيل شاشة المطبخ بنجاح",
  toast_kds_disabled_title: "تم تعطيل شاشة المطبخ",
  toast_kds_disabled_desc: "تم تعطيل شاشة المطبخ",
  toast_qr_enabled_title: "تم تفعيل طلبات QR",
  toast_qr_enabled_desc: "تم تفعيل الطلب عبر QR بنجاح",
  toast_qr_disabled_title: "تم تعطيل طلبات QR",
  toast_qr_disabled_desc: "تم تعطيل الطلب عبر QR",
  toast_module_error_title: "خطأ",
  toast_module_error_desc: "فشل تحديث الإعداد",

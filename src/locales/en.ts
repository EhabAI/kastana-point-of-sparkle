...
export default {
  ...
  "removing_last_item_warning": "will leave this order with no items. Consider cancelling the order instead if you want to close it.",
  "keep_item": "Keep Item",
  ...
  "void_order_warning_desc": "The order will be permanently voided. Items and order data will be preserved for audit purposes.",

...
export default {
  ...
  inv_item_deleted: "Item deleted successfully",
  inv_delete_item_title: "Delete Inventory Item",
  inv_delete_item_desc: "Are you sure you want to delete this item? This action cannot be undone:",
  ...
  inv_missing_unit: "Unit name is missing",
  inv_unit_create_failed: "Failed to create unit",
  inv_units_created: "new units created",
  ...
  recipes_failed: "Recipes failed",
  recipes_created_successfully: "Recipes created successfully!",
  import_errors: "Import Errors",
  csv_invalid_rows_warning: "Rows with errors will be skipped. Valid rows will be imported.",
  csv_error_menu_item_not_found: "Menu item not found",
  csv_error_menu_item_not_unique: "Multiple menu items found with this name",
  csv_error_inventory_item_not_found: "Inventory item not found",
  csv_error_inventory_item_not_unique: "Multiple inventory items found with this name",
  csv_error_unit_not_found: "Unit not found",
  csv_error_invalid_quantity: "Quantity must be a positive number",
  csv_error_database_error: "Failed to save recipe to database",
  ...
  sub_period_hint: "Paid subscription duration",
  sub_bonus_months: "Bonus Months (Free)",
  sub_bonus_months_max: "Maximum 3 bonus months",
  sub_bonus_months_hint: "Added to end date only (max 3 months)",
  ...
  sub_renew_preview: "New Period Preview",
  sub_renew_new_start: "New Start Date",
  sub_renew_new_end: "New End Date",
  sub_renew_expired_note: "Subscription will start from today as the previous subscription has expired",
  sub_renew_active_note: "Subscription will start from the day after the current subscription ends",
  sub_renew_success_title: "Renewal Successful",
  sub_renew_success_desc: "Subscription has been renewed successfully",
  sub_current_status: "Current Status",
  sub_current_end: "Current End Date",
  sub_active: "Active",
  ...
  sub_start_date_helper: "Select the subscription start date. You can edit this at any time.",
  sub_end_date: "End Date (Calculated)",
  sub_end_date_helper: "Automatically calculated based on start date, period, and bonus months.",
  sub_pick_date: "Pick a date",
  ...
  sa_sub_none: "No Sub",
  sa_sort_by: "Sort by",
  days_remaining_tooltip: "Days remaining until subscription expires",
  inv_enabled_tooltip: "Inventory management enabled",
  inv_disabled_tooltip: "Inventory management disabled",
  kds_enabled_tooltip: "Kitchen display enabled",
  kds_disabled_tooltip: "Kitchen display disabled",
  qr_enabled_tooltip: "QR ordering enabled",
  qr_disabled_tooltip: "QR ordering disabled",
  // Module toggle toast messages
  toast_inv_enabled_title: "Inventory Module Enabled",
  toast_inv_enabled_desc: "Inventory management has been enabled",
  toast_inv_disabled_title: "Inventory Module Disabled",
  toast_inv_disabled_desc: "Inventory management has been disabled",
  toast_kds_enabled_title: "Kitchen Display Enabled",
  toast_kds_enabled_desc: "Kitchen display has been enabled",
  toast_kds_disabled_title: "Kitchen Display Disabled",
  toast_kds_disabled_desc: "Kitchen display has been disabled",
  toast_qr_enabled_title: "QR Order Enabled",
  toast_qr_enabled_desc: "QR ordering has been enabled",
  toast_qr_disabled_title: "QR Order Disabled",
  toast_qr_disabled_desc: "QR ordering has been disabled",
  toast_module_error_title: "Error",
  toast_module_error_desc: "Failed to update setting",

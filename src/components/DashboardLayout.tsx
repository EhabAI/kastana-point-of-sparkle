        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 sm:h-11">
            ...
            <div className="hidden md:flex items-center justify-center flex-1">
              {displayName && (
                <span className="font-medium text-blue-800 dark:text-blue-100 text-sm font-sans">
            ...
            <div className="flex items-center gap-1">
              ...
              {/* Sign Out */}
              <Button variant="ghost" size="sm" onClick={handleSignOut} className="text-blue-700 dark:text-blue-200 hover:text-blue-900 dark:hover:text-white hover:bg-blue-200 dark:hover:bg-blue-800 h-7 px-1.5">

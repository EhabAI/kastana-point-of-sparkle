...
import { 
  ...
  Play, Pause, BookOpen, Layers, BarChart3, Building2, ArrowRight, Package
} from "lucide-react";
...
export function OwnerTrainingPanel({ 
  ...
  // Inventory status for state-aware messaging
  const { isEnabled: isInventoryEnabled, isLoading: isInventoryLoading } = useInventoryEnabled();
  ...
  return (
    <div className="p-4 bg-blue-50/50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800/50">
      ...
      <div className="mb-4">
        ...
        {/* Helper text for inventory step */}
